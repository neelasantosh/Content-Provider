...
public class PhoneNumberActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Uri uriForPhone = ContactsContract.CommonDataKinds.Phone.CONTENT_URI;

		Log.e("uri is:", uriForPhone.toString());

		ContentResolver resolver = getContentResolver();
		/* resolver.query(uri, projection, selection, selectionArgs, sortOrder); */

		Cursor cur = resolver.query(uriForPhone, null, null, null, null);
		...
		cur = resolver
				.query(uriForPhone, columns, null, null, "display_name");
		...
		cur.close();
		adapter = new ArrayAdapter<String>(PhoneNumberActivity.this,
